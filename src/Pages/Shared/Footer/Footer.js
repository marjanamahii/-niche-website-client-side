                        ...
                        <div className="row">
                            <div className="col-lg-3 col-sm-6">
                                <div className="address">
                                    <h3 className="text-uppercase fw-bold text-white">SHELTEK</h3>
                                    <p className="mb-4 mt-4">
                                        <FontAwesomeIcon icon={faMapMarkerAlt} /> Dhaka, Bangladesh, 1206.
                                    </p>
                                    <p>
                                        <FontAwesomeIcon icon={faPhoneAlt} /> ☎ +9111100 (10AM-5PM)
                                    </p>
                                    <p>
                                        <FontAwesomeIcon icon={faEnvelope} /> ladybugjewellery@gmail.com
                                    </p>
                                    <div className="my-5">
                            ...
                            <div className="col-lg-3 col-sm-6 footer-menus">
                                ...
                                <ul>
                                    <li><i className="fas fa-check"></i> <HashLink as={HashLink} to="/home#allPackages">Purchase Product</HashLink></li>
                            ...
                            <div className="col-lg-4 col-sm-6 newsletter">
                                <div>
                                    <img src="https://i.ibb.co/f9DTQ9t/payment-gateway.png" alt="" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <p >
                                    Copyright &copy; <span id="currentYear"></span> Lady Bug Jewellery | Site designed by <a
                                        href=" " target="_blank" rel="noreferrer" title="Yellow Devs Website">
                                        <span className="text-white"  >Lady Bug Jewellery</span></a>
                                </p>
                            </div>
                        </div>
                    </div>
